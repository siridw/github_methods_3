...
We see that there's a 34% increase in accuracy when going from pas2 to pas3 hence wwe fail to reject the null-hypothesis that there's not a faster increase in accuracy when going from pas2 to pas3.
